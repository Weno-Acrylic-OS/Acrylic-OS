...
## Stage 1: Create New personalities/interfaces for different device types, including (desktop, phone, smarthome) - ⚒️ In Development

### Stage 1A: Create Desktop interface - ✅ Completed

### Stage 1B: Create Phone interface - ✅ Completed

### Stage 1C: Create Smart Home Interface - ⚒️ In Development

## Stage 2: Add new basic fundemental features and services to all new personalities -  ⛔️ Untouched and Not completed
